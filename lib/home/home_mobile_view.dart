...
import 'package:personal_portfolio/home/widgets/experience_tile.dart';
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(
                "ALGIN ANTO",
                style: context.headL.w700
                    .copyWith(fontSize: 43)
                    .col(AppColors.fontPrimaryColor),
              ),
              10.hBox,
              Text(
                "Software Engineer at DataFloat",
              ...
              Text(
                ...
                style: context.bodyM.w400
                    .col(AppColors.fontPrimaryColor.withOpacity(0.5))
              ...
              Row(
                ...
                children: [
                  IconButton(
                    onPressed: () async {
                      final uri = Uri.parse("https://github.com/Algin-anto/");
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          "${details["title"]}",
          style: context.bodyM.col(AppColors.fontPrimaryColor).w600,
        ),
        10.hBox,
        Text(
          "${details["description"]}",

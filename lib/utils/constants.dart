...
List<StringMap> expList = [
  {
    ...
    "company": "Datafloat",
    "description":
        "Developed and supported CRM app, 'IDC CRM' using Flutter. Developing another app 'One Suite', used for real estate industry.",
    "skills": ["Flutter", "Firebase", "Bloc", "Android", "iOS"]
  },
];
...
List<StringMap> projectList = [
  {
    ...
    "title": "IDC CRM App",
    "description":
        "Crafted a Flutter-based CRM app . The Mobile companion for real estate Companies using IDC Global Platform. Integrated intuitive UI and backend functionalities. Proficient in Flutter,And API integration",
    "skills": ["Flutter", "Dart", "API Integration"],
    "img":
        "https://play-lh.googleusercontent.com/dwyv4QgWNJ5aDLNSr_JVm3Jyqa29fVwJLte9TI24-pmuKk06BhoJB9rLSifdLCZrf1U=w240-h480-rw",
  },
  {
    "id": 4,
    "title": "MyHub by Premier SIR",
    "description":
        "Flutter-based CRM app .The MyHub CRM app is a mobile companion to the Premier Sotheby’s Realty MyHub platform. Integrated intuitive UI and backend functionalities. Proficient in Flutter,And API integration",
    "skills": ["Flutter", "Dart", "API Integration"],
    "img":
        "https://play-lh.googleusercontent.com/0VP9zoN4Y9ln06zJr4EO-8ObMw1xDpo9su3GPpwFPKIe2QroU9qO3xvdCjcngVE-3g=w240-h480-rw",
  },
];
